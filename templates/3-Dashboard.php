<?php 
    ...
    {
        $today_expense = "Rs ".$today_expense;
    }
    ...
    {
        $Yesterday_expense = "Rs ".$Yesterday_expense;
    }
    ...
    {
        $monthly_expense = "Rs ".$monthly_expense;
    }
